...
ActiveRecord::Schema.define(version: 20160929162351) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "mail_correction",        default: true
    t.boolean  "mail_new_test",          default: true
    t.boolean  "mail_new_post",          default: true
  end
